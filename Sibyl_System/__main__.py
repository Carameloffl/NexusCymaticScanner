...
async def status(event):
    msg = await event.reply("Waiting For Server's Response.....")
    time.sleep(1)
    await msg.edit("Status Of Servers = 🆙")
    time.sleep(2)
    await msg.edit("Waiting For Server Approval...")
    time.sleep(1)
    await msg.edit("Server Approval = ✅")
    time.sleep(2)
    await msg.edit("Awaiting Database Status...")
    time.sleep(1)
    await msg.edit("Status Of Database = 🆙")
    time.sleep(2)
    await msg.edit("Waiting For Database Approval...")
    time.sleep(1)
    await msg.edit("Database Approval = ✅")
    time.sleep(2)
    await msg.edit("Awaiting Status Of System....")
    time.sleep(1)
    await msg.edit("Status Of System = 🆙")
    time.sleep(2)
    await msg.edit("Awaiting System's Response....")
    time.sleep(7)
    await msg.edit("Received System Response! Displaying It In This Chat...")
    time.sleep(2)
